...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.singleton<_i274.TokenCacheManager>(
      () => _i274.TokenCacheManager(
        gh<_i100.GetStorageService>(),
        gh<_i762.CoreLogger>(),
      ),
    );
    gh.singleton<_i591.AuthManager>(
      () => _i591.AuthManager(
        gh<_i100.GetStorageService>(),
        gh<_i762.CoreLogger>(),
      ),
    ...
    gh.factory<_i935.AuthService>(() => _i935.AuthService(gh<_i361.Dio>()));
    gh.factory<_i858.AuthRepository>(

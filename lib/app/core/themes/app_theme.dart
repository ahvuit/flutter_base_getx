...
class AppTheme {
  static ThemeData lightTheme() {
    return ThemeData(
      ...
      appBarTheme: const AppBarTheme(color: Colors.blue, foregroundColor: Colors.white),
  ...
  static ThemeData darkTheme() {
    return ThemeData(
      ...
      appBarTheme: AppBarTheme(color: Colors.grey[850], foregroundColor: Colors.white),
      elevatedButtonTheme: ElevatedButtonThemeData(
        style: ElevatedButton.styleFrom(foregroundColor: Colors.white, backgroundColor: Colors.blueGrey),
      ),
